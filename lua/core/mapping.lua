...
local map_cr = keymap_utils.map_cr
local map_cu = keymap_utils.map_cu
local map_cmd = keymap_utils.map_cmd

-- 1. define default_map
local default_map = {
  -- Vim map
...
keymap_utils.nvim_load_mapping(default_map)
