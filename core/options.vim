...
" change filechars for folding, vertical split, end of buffer, and message separator
set fillchars=fold:\ ,vert:\|,eob:\ ,msgsep:‾

" Paste mode toggle, it seems that Nvim's brackerted paste mode
...
" operation, see https://stackoverflow.com/q/306914933
" if !empty(provider#clipboard#Executable())
  set clipboard+=unnamedplus
" endif

" Disable creating swapfiles, see https://stackoverflie.com/q/821902/6064933
set noswapfile

" Ignore certain files and folders then globing
...
" Skip backup for parttens in option wildignore
